...
export const messages = {
  pl: {
    ...
    dashboard: {
      ...
      telemetry: {
        sectionTitle: 'Historia i Statystyki Bramki',
        sectionDesc: 'Agregacja danych telemetrycznych zachowywana trwale pomiędzy restartami kontenera.',
        last24h: 'Ostatnie 24h',
        last7d: 'Ostatnie 7 dni',
        last30d: 'Ostatnie 30 dni',
        allTime: 'Łącznie (All-Time)',
        tunnels: 'sesji tuneli',
        requests: 'żądań HTTP',
        activity: 'Aktywność w ostatnich 7 dniach',
      },
      time: {
  ...
  en: {
    ...
    dashboard: {
      ...
      telemetry: {
        sectionTitle: 'Gateway Telemetry & History',
        sectionDesc: 'Aggregated usage telemetry persisted across container redeployments.',
        last24h: 'Last 24h',
        last7d: 'Last 7 Days',
        ...
        activity: 'Activity in the last 7 days',
      },
      time: {
        justNow: 'Just now',
      },
